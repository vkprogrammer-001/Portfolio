...
const ExperienceSection = () => {
  ...
  const experiences = [
    {
      ...
      technologies: ["ReactJS", "Flutter", "Microservices", "REST APIs", "MySQL", "MongoDB", "Full-Stack", "Nginx"],
    },
    {
      ...
      technologies: ["Go", "TypeScript", "MySQL", "MongoDB", "CI/CD", "ORMs", "Backend"],
    },
    {
      ...
      type: "Internship",
      description: [
        "Accepted into Google Summer of Code 2024, contributing to the Monumento AR/VR project under AOSSIE.",
        "Enhanced AR features and improved UI/UX for mobile platforms using Flutter and Firebase.",
        "Collaborated with mentors on implementing geolocation features and 3D model rendering.",
      ],
      technologies: ["Flutter", "AR/VR", "Firebase", "Dart", "Google Maps API"],
    },
  ];
  ...
  return (
    <section id="experience" className="section relative overflow-hidden" ref={sectionRef}>
              ...
              return (
                ...
                >
                  ...
                  <div className="hidden md:block absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10">
                    <div className={`relative transition-all duration-700 delay-200 ${isVisible ? 'scale-100 opacity-100' : 'scale-0 opacity-0'}`}>
