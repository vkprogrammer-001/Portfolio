      ...
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="glass-card p-6 text-center group hover:border-primary/20 transition-all animate-fade-in">
            ...
            <h3 className="text-xl font-bold mb-3 group-hover:text-primary transition-colors">Google Summer of Code 2024</h3>
            <p className="text-foreground/70 mb-4">
              Successfully collaborated with AOSSIE to enhance the "Monumento" project, integrating augmented reality features and improving the UI/UX.
            </p>
            <a 
          ...
          <div className="glass-card p-6 text-center group hover:border-primary/20 transition-all animate-fade-in" style={{ animationDelay: "0.2s" }}>
            <div className="relative mb-6">
            ...
            <h3 className="text-xl font-bold mb-3 group-hover:text-secondary transition-colors">Tech Blitz – Game of Codes</h3>
            <p className="text-foreground/70 mb-4">
              Secured 3rd place in the competitive coding competition, demonstrating strong problem-solving abilities and algorithmic thinking.
            </p>
          ...
          <div className="glass-card p-6 text-center group hover:border-primary/20 transition-all animate-fade-in" style={{ animationDelay: "0.4s" }}>
            <div className="relative mb-6">
            ...
            <h3 className="text-xl font-bold mb-3 group-hover:text-accent transition-colors">Leetcode Problem Solving</h3>
            <p className="text-foreground/70 mb-4">
              Consistently practicing and improving problem-solving skills by tackling challenging algorithms and data structure problems.
            </p>
            <div className="mt-4">
              <div className="inline-flex items-center bg-accent/10 rounded-full px-4 py-2">
                ...
                <span className="ml-2 text-sm text-foreground/70">Problems Solved</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-16">
          <div className="bg-gradient-to-r from-primary/10 to-secondary/10 rounded-xl p-8 text-center">
            <h3 className="text-2xl font-bold mb-4">Want to collaborate on exciting projects?</h3>
